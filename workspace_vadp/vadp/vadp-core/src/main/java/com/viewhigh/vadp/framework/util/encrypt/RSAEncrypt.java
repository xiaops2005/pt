...
public class RSAEncrypt {
	...
	public RSAEncrypt(String publicKey) throws Exception {
	...
	public String decryptPublicKey(String cipherData) {
		String result = "";
		try {
			byte[] data = Base64.decodeBase64(cipherData.getBytes());
	...
	public String sign(byte[] data, String privateKey) throws Exception {
		...
		return new String(Base64.encodeBase64(signByte), "UTF-8");
	}
