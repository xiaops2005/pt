...
import {Modal, Button, Tooltip, Affix, Layout, Menu, Icon, Row, Col} from 'antd';
import Header from './Header';
import Sidebar from './Sidebar';
import Aside from './Aside';
import {affixData, sideNavConfig, sideNavPin} from '../../../ui/models/actions/uiAction';
  ...
  render() {
    ...
    return (
      <Layout style={{height: '100vh'}}>
        ...
        <div
          style={{width: '240px', height: '70px', backgroundColor: '#2a5bb5', position: 'absolute', overflow: 'auto'}}>
            ...
            <div style={{position: 'absolute'}}>
              <Affix style={{position: 'absolute', top: '50px', left: '-45px', zIndex: '9'}}>
                <div style={{width: '32px', height: '90px'}}>
                  <Tooltip title="主菜单">
                    <Button shape="circle" icon="bars" onClick={this.setMenusClick} style={{
                      marginBottom: '10px',
                      border: 'none',
                      color: '#fff',
                      backgroundColor: '#4e92f5',
                      boxShadow: '0 0 5px 0 #4e92f5'
                    }}/>
                  </Tooltip>
                  <Tooltip title="角色切换">
                  ...
                  <Tooltip title="收藏夹">
                    <Button shape="circle" icon="star" onClick={this.setFavoritesClick} style={{
                      border: 'none',
                      color: '#f6a623',
                      backgroundColor: '#fff',
