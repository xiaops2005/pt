...
class Header extends Component {
  ...
  render() {
    return (
      <div style={{backgroundImage:'linear-gradient(-90deg, #4f8aee 3%, #2a5bb5 100%)',height:'70px',border:0,margin:0,paddingLeft:'20px',position:'fixed',zIndex:'999',width:'100%'}}>
