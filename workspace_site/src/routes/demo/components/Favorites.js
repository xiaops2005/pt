...
import {Button,Menu,Icon} from 'vdap-ui';
import {NavLink} from 'react-router-dom';
import { connect } from 'react-redux';
import  {sideNavPin} from 'routes/ui/models/actions/uiAction';
  ...
  render(){
    ...
    return (
      <div style={{zIndex:9999 }}>
         ...
         <Menu  className="favorites"  theme="light" mode="inline" defaultSelectedKeys={['two']} style={{height:'95vh',width:'200px',overflow: 'initial',backgroundColor:'white'}}>
          {topmenu?
